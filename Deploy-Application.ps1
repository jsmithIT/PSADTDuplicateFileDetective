...
Try {
	...
	[string]$appName = 'Duplicate File Detective'
	[string]$appVersion = '7.2.65'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	...
	$CloseApps = "Duplicate File Detective"
	...
	#$RemoveAppNamesMSI = @("")
	$RemoveAppNamesEXE = @("Duplicate File Detective")
	...
	# Application uninstall parameters.
	$64bitAppUninstallParam = "/x {374583A4-3C40-493E-BEDC-8829D9205619} /qn"
	# Retired Application uninstall parameters.
	$64bitAppUninstallParam2 = "/x {D17A0DC7-2C63-4207-BB13-342E40DD2045} /qn"
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Remove-Item -Path "${Env:PUBLIC}\Desktop\Duplicate File Detective 7.lnk"
